    ...
    <div class="column column-80">
        <div class="articles view content">
            ...
            <table>
                <tr>
                    <th><?= __('User') ?></th>
                    <td><?= $article->hasValue('user') ? $this->Html->link($article->user->name, ['controller' => 'Users', 'action' => 'view', $article->user->id]) : '' ?></td>
                </tr>
                <tr>
                    <th><?= __('Subcategory') ?></th>
                    <td><?= $article->hasValue('subcategory') ? $this->Html->link($article->subcategory->name, ['controller' => 'Subcategories', 'action' => 'view', $article->subcategory->id]) : '' ?></td>
                </tr>
                <tr>
                    <th><?= __('Image') ?></th>
